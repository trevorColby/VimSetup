#!usr/bin/env bash
echo "Second prototype trial alpha"
echo "Creator: Trevor Colby"
echo "Last Updated: 12/26/2017"
PLUGIN_DIR="usr/local/bin/vim/bundle"
...
echo " - Install Vundle a vim plugin manager"
